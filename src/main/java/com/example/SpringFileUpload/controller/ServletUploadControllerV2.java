...
public class ServletUploadControllerV2 {
    ...
    public String saveFilev1(MultipartHttpServletRequest request) throws ServletException, IOException {
        ...
        for (Part part : parts) {
            ...
            Collection<String> headerNames = part.getHeaderNames(); // parts도 헤더와 바디로 구분되어 있다.
            for (String headerName : headerNames) {
                log.info("hearder {} : {}", headerName, part.getHeader(headerName));
            }

            // 편의 메서드도 제공
            // Content-disposition; filename
            log.info("submittedFilename = {}", part.getSubmittedFileName()); // 사용자가 전송한 파일명
